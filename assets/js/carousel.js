...
$(window).on("load", function () {
    ...
    $(".sw-fix-scroll").each(function (i, el) {
        ...
        const paginationEl = $this.find('.tf-sw-pagination')[0];
        ...
        const swiper = new Swiper(el, {
            ...
            breakpoints: {
                576: { slidesPerView: mobile, spaceBetween: space },
                768: { slidesPerView: tablet, spaceBetween: space },
                1200: { slidesPerView: preview, spaceBetween: space }
            },
    ...
    function enableScrollSync() {
        $(window).on('scroll.swiperScroll', function () {
