...
<head>
    ...
    <title>SmartMenu™ :: The Future of Ordering, One Scan Away</title>

    <meta name="author" content="Webify">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    
    <meta name="description" content="SmartMenu is a fast, user-friendly digital menu platform that lets restaurants create QR code menus, manage updates in real time, and offer a seamless contactless dining experience. Perfect for restaurants, cafés, hotels, and bars across Africa.">
    <meta property="og:url" content="https://smartmenu.africa/"/>
    ...
    <link rel="shortcut icon" href="./assets/images/smartmenu-favicon.ico">
    <link rel="apple-touch-icon-precomposed" href="./assets/images/smartmenu-favicon.ico">
</head>

<body class="demo-financial counter-scroll sticky-scroll">
    <!-- Scroll Top -->
    <button id="goTop">
